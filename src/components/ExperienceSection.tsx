...
const journey: RouteStop[] = [
  {
    ...
    description: 'Engineered cross-platform mobile and responsive web applications utilizing modern full-stack workflows and scalable architectures[cite: 3].',
  },
  {
    id: '02',
    year: 'JUN 2025 - MAR 2026',
    title: 'WEB DEVELOPER',
    organization: 'FULL-STACK & WEB SOLUTIONS',
    description: 'Designed and deployed dynamic property listings, robust web platforms, and responsive user interfaces with optimized performance.',
  },
  {
    id: '03',
    year: 'JAN 2025 - JUN 2025',
    title: 'FRONTEND DEVELOPER',
    organization: 'UI/UX & CLIENT ENGINEERING',
    description: 'Specialized in building high-performance client applications, custom component libraries, and immersive responsive interfaces.',
  },
  {
    id: '04',
    year: 'MAY 2024 - DEC 2024',
    title: 'DATA ENGINEER',
    organization: 'DATA PIPELINES & ANALYTICS',
    description: 'Focused on foundational data engineering concepts, Python data structures, ETL workflows, and relational database modeling[cite: 3].',
  },
];
